...
public final class DynamicQueryBuilder {
    ...
    private static class Holder {
        private static final DynamicQueryBuilder INSTANCE = new DynamicQueryBuilder();
    }
     ...
     */
    public Pageable buildPageable(DynamicFilterRequest request) {
     ...
     * Tạo Sort từ sort criteria
     */
    public Sort buildSort(List<DynamicFilterRequest.SortCriteria> sortCriteria) {
     ...
     */
    public List<String> validateRequest(DynamicFilterRequest request) {
     ...
     */
    private List<String> validateCriteria(DynamicFilterRequest.FilterCriteria criteria, int index) {
        List<String> errors = new ArrayList<>();
     ...
     * Validate sort criteria
     */
    private List<String> validateSortCriteria(DynamicFilterRequest.SortCriteria criteria, int index) {
        List<String> errors = new ArrayList<>();
